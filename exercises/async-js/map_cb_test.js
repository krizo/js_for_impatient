...
test('toUpperCaseCb', done => {
  mapCb(['foo', 'bar', 'baz'], toUpperCaseCb, function(error, result) {
...
test('illegal first argument', done => {
  mapCb(null, toUpperCaseCb, function(error, result) {
...
test('empty', done => {
  mapCb([], toUpperCaseCb, function(error, result) {
    assert.equal(error, null);
...
test('returnIndexCb', done => {
  mapCb([0, 0, 0, 0], returnIndexCb, function(error, result) {
    assert.equal(error, null);
