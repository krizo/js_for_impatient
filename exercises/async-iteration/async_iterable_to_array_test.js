...
test('asyncIterableToArray', async () => {
  assert.deepEqual(await asyncIterableToArray(yieldArray([])), []);
  assert.deepEqual(await asyncIterableToArray(yieldArray(['a', 'b'])), [
    'a',
    'b',
  ]);
  assert.deepEqual(await asyncIterableToArray(yieldArray(['a', 'b', 'c'])), [
    'a',
    'b',
    'c',
  ]);
